...
<div  id="saveOrUpdateDiv">
    <from class="layui-form" action="/add"  lay-filter="dataFrm" mehtod="post" onsubmit="return check()">
                ...
                <div class="content-pages-wrap">
                    ...
                    <table border="0" cellspacing="1" cellpadding="0" class="commonTable">
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="3"><input name="orgcode" type="text" class="inputTextMiddle" id="orgcode"/></td>
                            </tr>
                            <tr>
                                <td align="right"><span class="required">*</span>机构名称：</td>
                                <td align="left"><input name="td0Organization.orgname" type="text" class="inputTextMiddle" id="orgname" /></td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" align="left"><input name="td0Organization.linkadd" type="text" class="inputTextLong" id="textfield5" /></td>
                                <td align="right">邮编：</td>
                                <td align="left"><input name="td0Organization.zipcode" type="text" class="inputTextNormal" id="textfield4" /></td>
                            </tr>
                            <tr>
                                <td align="right"><span class="required">*</span>行政区划：</td>
                                <td align="left"><input name="td0Organization.areacode" type="text" class="inputTextNormal"  /></td>
                                <td align="right">挂牌日期：</td>
                                <td align="left"><input name="td0Organization.listingdate" type="date" class="inputTextNormal"/></td>
                                <td align="right">独立运行日期：</td>
                                <td align="left"><input name="td0Organization.standalonedate" type="date" class="inputTextNormal" id="textfield7" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><input name="td0Organization.zbbdocdate" type="date" class="inputTextNormal" id="textfield936" /></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left"><input name="officebuildingarea" type="text" class="inputTextNormal" /></td>
                            ...
                            <tr>
                                ...
                                <td align="left" colspan="5"><input name="equ3count" colspan="2" type="text"  size="4" />（价格大于一千,小于一万）<br/>
                                    ...
                                    <input name="equ1count" type="text"  size="4" />（价格大于十万）</td>
                            </tr>
                            <tr>
                                ...
                                <td align="left"><input name="rapidtestvehiclecount" type="text" class="inputTextNormal"  /></td>
                    ...
                    <div id="formPageButton">
                        <ul>
                            <li><input onclick="f()" title="提交" type="submit" class="btnShort" /></li>
