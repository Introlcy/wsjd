...
<div class="content-pages-wrap">
    ...
    <table border="0" cellspacing="1" cellpadding="0" class="commonTable">
        ...
        <#list listMember as p>

            <tr>

                <td align="center">${p.humanCode}</td>
                <td align="center">${p.organization}</td>
                <td align="center">${p.section}</td>
                <td align="left">${p.name}</td>
                <td align="center">${p.sex}</td>
                <td align="left">${p.degree}</td>
                <td align="center">${p.job}</td>
                <td align="center">${p.grade}</td>
                <td align="center">${p.job}</td>
                <td align="center">
                    <a href="/content/memberView/${p.humanCode}" class="btnIconView" title="查看详情"></a>
                    <a href="member-edit.ftl" class="btnIconEdit" title="更新"></a>
